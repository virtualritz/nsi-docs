...
which do not reflect modern needs.
...
|   All API design decisions are made with performance in mind and this
    ...
    does not become a single thread communication bottleneck. This is
    why commands are self-contained and do not rely on a current state.
...
|   The interface should have as few assumptions as possible built-in
    ...
    abstract enough that new features can be added without looking out
    of place.
