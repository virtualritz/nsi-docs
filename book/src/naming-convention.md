...
This document proposes a systematic naming convention that resolves these inconsistencies. The complete mapping from current to proposed names is in the [attribute mapping](#complete-attribute-mapping) below.
